...
from src.rag.rag import get_quiz_llm, get_quiz_fallback_llm, LocalVectorRetriever, _agentic_gather_web_content
...
def _contextual_quiz(difficulty, mcq_count, tf_count, context, material_id):
    ...
    prompt = _quiz_prompt()
    retriever = LocalVectorRetriever(material_id=material_id, k=RETRIEVER_K)
